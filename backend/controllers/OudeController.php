...
class OudeController extends Controller
{
	...
	public function actionAdd()
	{
		...
		$successAddToStudent = Graduation::addToStudent($student, $data); 
		
		$successAddToStudentRecord = Graduation::addToStudentRecord($studentRecord, $data);
		
		$successAddToSemesterStudent = Graduation::addToSemesterStudent($semesterStudent, $data);
		
		//return $successAddToStudent . ', ' . $successAddToStudentRecord . ', ' . $successAddToSemesterStudent;
		
		if ($successAddToStudent && $successAddToStudentRecord && $successAddToSemesterStudent) // nếu tất cả được thêm vào database thành công
